...
function injectGlobalStyles() {
  ...
  style.textContent = `
    ...
    .sidebar { 
    /* حساب الارتفاع: الشاشة كاملة ناقص 70 بكسل (حجم الهيدر) لضمان عدم خروج المنيو عن الشاشة */
    height: calc(100vh - 70px); 
    
    /* تحديد العرض بناءً على المتغير الذي عرفناه سابقاً (225px) */
    width: var(--sidebar-w); 
    
    /* تثبيت القائمة في مكانها حتى عند تحريك محتوى الصفحة */
    position: fixed; 
    
    /* تحديد طبقة الظهور ليكون فوق محتوى الصفحة وتحت الهيدر أو فوقه حسب الحاجة */
    z-index: 3000; 
    
    /* نقطة البداية من الأعلى: تبدأ تماماً بعد نهاية الهيدر (70 بكسل) */
    top: 70px; 
    
    /* إخفاء القائمة جهة اليمين تماماً (بمقدار عرضها) خارج حدود الشاشة */
    right: calc(var(--sidebar-w) * -1); 
    
    /* لون الخلفية: أسود داكن شفاف جداً لإعطاء مظهر عصري */
    background: rgba(18, 18, 18, 0.98); 
    
    /* تأثير الضبابية: جعل المحتوى خلف القائمة يبدو مموهاً بشكل احترافي */
    backdrop-filter: blur(25px); 
    
    /* تحديد حركة الظهور: تستغرق 0.8 ثانية لتكون ناعمة جداً وانسيابية */
    transition: transform 0.8s ease-in-out; 
    
    /* السماح بالتمرير العمودي إذا كانت روابط المنيو أكثر من طول الشاشة (حل مشكلة الآيفون) */
    overflow-y: auto; 
    
    /* تحسين ملمس التمرير على أجهزة آبل (iOS) ليكون سريعاً وسلساً باللمس */
    -webkit-overflow-scrolling: touch; 
    
    /* مسافة داخلية علوية: بسيطة لأن القائمة لم تعد تبدأ من أعلى الشاشة */
    padding-top: 10px; 
    
    /* مسافة داخلية سفلية: لضمان عدم اختفاء آخر رابط خلف أزرار التنقل في الموبايل */
    padding-bottom: 50px; 
    
    /* لمسة جمالية: خط نحيف جداً بلون ذهبي على الحافة اليسرى لتمييز القائمة */
