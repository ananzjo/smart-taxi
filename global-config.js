...
function injectGlobalStyles() {
    ...
    style.textContent = `
        ...
        .record-counter-capsule {
            background: rgba(255,255,255,0.1); border: 1px solid var(--taxi-gold);
            padding: 5px 15px; border-radius: 20px; display: flex; align-items: center; gap: 8px; margin-right: 15px;
        }
        .record-count-num { color: var(--taxi-gold); font-weight: 900; font-size: 1.1rem; transition: 0.3s; display: inline-block; }
