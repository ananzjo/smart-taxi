/**
 * نظام إدارة التاكسي الذكي - الإصدار الاحترافي المدمج
 * التحديث: حركة "الباليه" للزر (شفافية + طيران للمنتصف الأعلى)
 */

(function() {
    // 1. نظام الحماية ومنع الدخول المباشر
    ...
    // 2. حقن الهيكل (الزر، التظليل، والقائمة)
        ...
        <aside id="main-sidebar" 
            ...
            <div class="flex items-center justify-between mb-10 px-2 border-b border-white/5 pb-6">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-lg font-black text-white tracking-tight">التاكسي الذكي</h1>
                </div>
    ...
    // 3. وظيفة التبديل (دالة الحركة المدمجة)
    window.toggleSidebar = function() {
        const sidebar = document.getElementById('main-sidebar');
        const overlay = document.getElementById('sidebar-overlay');
        const toggleBtn = document.getElementById('sidebar-toggle-btn');

        // فحص الحالة الحالية للقائمة
        ...
        if (!isOpen) {
            ...
            // حركة الزر: طيران لمنتصف الأعلى + شفافية كاملة
            ...
            // إعادة الزر لمكانه الطبيعي في الزاوية
            toggleBtn.style.cssText = `
                opacity: 1 !important;
